...
public sealed class CommandRegistrationGeneratorTests
{
    ...
    {
        (_, ImmutableArray<GeneratedSourceResult> sources) = RunGenerator("public class NotACommand { }");
    ...
    public void GeneratesRegistration_ForSingleStandaloneCommand()
    {
        ...
        (_, ImmutableArray<GeneratedSourceResult> sources) = RunGenerator(source);
    ...
    public void StandaloneCommands_AreOrderedAlphabetically()
    {
        ...
        string text = sources[0].SourceText.ToString();
        Assert.True(
    ...
    public void GeneratesThreeLevelNesting()
    {
        ...
        Assert.Contains("new DeepCommand()", text);
        int posA = text.IndexOf("new SubMenuCommand(\"A\"", StringComparison.Ordinal);
        int posB = text.IndexOf("new SubMenuCommand(\"B\"", StringComparison.Ordinal);
        int posC = text.IndexOf("new SubMenuCommand(\"C\"", StringComparison.Ordinal);
